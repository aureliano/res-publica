...
database_name = case Padrino.env
  ...
  when :production  then 'cd_organizacional_production'
...
#     sessions:
#       default:
#         database: cd_organizacional_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: cd_organizacional_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: cd_organizacional_test
#         hosts:
#           - localhost:27017
#
#
